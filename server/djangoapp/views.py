...
def get_dealerships(request):
    if request.method == "GET":
        context = {}
        url = "https://alexf97-3000.theiadocker-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/api/dealership"
...
def get_dealer_details(request, dealer_id):
    ...
    review_url  = "https://alexf97-5000.theiadocker-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/api/get_reviews?id="+str(dealer_id)
